...
class CavsDataset(Dataset):
    ...
    def __init__(
        ...
        super(CavsDataset, self).__init__()
        ...
        print(f"Loaded {len(self.data_list)} samples from {data_root}")
    ...
    def get_data(self, idx):
        ...
        if "intensity" in data_dict.keys():
            data_dict["intensity"] = data_dict["intensity"].reshape(-1, 1).astype(np.float32)

        if "reflectivity" in data_dict.keys():
            data_dict["reflectivity"] = data_dict["reflectivity"].reshape(-1, 1).astype(np.float32)
...
#     split='train',
#     data_root='path/to/processed/dataset',
#     transform=[
#         dict(type='NormalizeColor'),
#         dict(type='CenterAndNormalize')
#     ]
# )
