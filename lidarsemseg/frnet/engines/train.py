...
from ...dataprocessin import build_dataset, point_collate_fn, collate_fn
from ...pt_network import build_model
...
class Trainer(TrainerBase):
    ...
    def run_step(self):
        ...
        with torch.amp.autocast(device_type='cuda', enabled=self.cfg.enable_amp):
            # print(input_dict)
            output_dict = self.model(input_dict) # problem was using wrong spconv version
